...
import com.hsmdevelopers.util.ExcelReader;
...
public class EmployeeController {
    ...
    private boolean isValid() {
        if (!Regex.setTextColor(com.hsmdevelopers.util.TextField.NAME, txtName)) return false;
        return true;
    }
    ...
    void txtNameKeyReleaseAction(KeyEvent event) {
        Regex.setTextColor(com.hsmdevelopers.util.TextField.NAME, txtName);
    }
